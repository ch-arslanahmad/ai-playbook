...
For Claude, they are also called `slash commands` (however they are only a type of slash commands, not the only ones), because they are invoked with a slash command.
...
- [caveman](https://github.com/JuliusBrussee/caveman/blob/main/skills/caveman/SKILL.md), to get a to-the-point answers, output and saves token.
- [humanizer](https://github.com/blader/humanizer/blob/main/SKILL.md), to get humanized answers & output and write humanizer documents.
- [frontend-design](https://github.com/anthropics/skills/blob/main/skills/frontend-design/SKILL.md), to get frontend design related answers & get better designed thinking & generation of UI/UX.
